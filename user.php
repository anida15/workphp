                        ...
                        <ul class="nav-right">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="notification-user">Goverment</h5>
                                                <p class="notification-msg">Complete your voting Session On this Week</p>
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="notification-msg">Make Sure you have Completed  registration</p>
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="notification-user">Jobcal</h5>
                                                <p class="notification-msg">Vote For Me As Mp Of Ujumba</p>
                            ...
                            <li class="user-profile header-notification ">
                                <a href="#!" class="waves-effect waves-light">
                                    ...
                                    <?php echo("<img class   src=\"{$_SESSION['image']}\" />"); ?>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <img src="assets/images/kenya1.jpeg"  alt="User-Profile-Image">
                            ...
                            <div class="pcoded-navigation-label">election</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-id-badge"></i><b>A</b></span>
                                        <span class="pcoded-mtext">VOTING SECTION</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="#" class="waves-effect waves-dark">
                                                ...
                                                <span class="pcoded-mtext">Voting Center</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="#" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Show Aspirants</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Voter Account</h5>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <br><?php echo("<img src=\"{$_SESSION['image']}\" />"); ?><br><br>
                                        <label>First Name &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :
                                        </label><label><?php echo($_SESSION['fname']);?></label><br>
                                        <label>Middle Name &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['mname']);?></label> <br>
                                        <label>Last Name &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['lname']);?></label> <br>
                                        <label>Email Address &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['email']);?></label> <br>
                                        <label>National ID &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['nationalid']);?></label> <br>

                                        <label>Phone Number &nbsp; &nbsp; : </label> <label
                                            for=""><?php echo($_SESSION['phone']);?></label> <br>
                                        <label>County &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['county']);?></label> <br>
                                        <label>Constituency &nbsp; &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['constituency']);?></label> <br>
                                        <label>Ward &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                            &nbsp; : </label> <label><?php echo($_SESSION['ward']);?></label> <br>
                                        <label>Polling Center &nbsp; &nbsp; &nbsp; : </label>
                                        <label><?php echo($_SESSION['polling']);?></label> <br>
